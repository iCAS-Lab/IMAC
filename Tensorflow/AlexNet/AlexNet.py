...
model = Sequential([
  Conv2D(96, kernel_size=(11,11), strides=4, activation="relu", input_shape=(54,54,1), padding="same"),
  BatchNormalization(),
...
history = model.fit(x_train, y_train, validation_data=(x_test, y_test), epochs=200, callbacks=[IntervalEvaluation()])
